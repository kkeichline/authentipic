...
app = FastAPI(title="AuthentiPic API", description="API for AI-generated image detection")
...
async def analyze_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        results = {
            ...
            "confidence": "high" if abs(prob_ai_generated - 0.5) > 0.3 else "medium" if abs(prob_ai_generated - 0.5) > 0.15 else "low"
        }
