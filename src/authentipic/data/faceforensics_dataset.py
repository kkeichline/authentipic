...
class FaceForensicsDataset(BaseDataset):
    ...
    def load_data(self):
        images, labels = [], []
        real_dir = os.path.join(self.root_dir, 'original_sequences', 'youtube', 'c23', 'videos')
        fake_dir = os.path.join(self.root_dir, 'manipulated_sequences', 'Deepfakes', 'c23', 'videos')
